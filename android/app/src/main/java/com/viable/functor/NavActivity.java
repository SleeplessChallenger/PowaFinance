...
import com.viable.functor.databinding.ActivityNavBinding;
import com.viable.functor.serialization.Expense;
...
public class NavActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarNav.fab.setOnClickListener(view -> showAddExpenseDialog());
    ...
    private void showAddExpenseDialog() {
        ...
        choose_date.setOnClickListener(view -> {
